                        ...
                        <nav class="cl-effect-15" id="cl-effect-15">
                            <ul class="nav navbar-nav">
                                <li><a href="index.php">Home</a></li>
                                            ...
                                            <li class="active"><a href="place.php">Find Place</a></li>
<?php
											if(!isset($_SESSION['is_user_login']))
											{	?>	                
...
<!-- gallery -->
	<div class="banner-bottom gallery">
		...
		<div class="wthree_head_section">
				<h2 class="w3l_header">Find <span>Places</span></h2>
			</div>
			<!---728x90--->
                ...
                <div class="contact-agileits">
                    <form action="place.php" method="post">
                        ...
                        <div class="control-group form-group">
                            <div class="controls">
                                <label class="contact-p1">Place Type:</label>
                                <select class="form-control" name="type">
                                    <option value="1">Hill Station</option>
                                    <option value="2">Deserts</option>
                                    <option value="4">Romantic Places</option>
                        ...
                        <div class="control-group form-group">
                            <div class="controls">
                                <label class="contact-p1">No of Persons:</label>
                                <select class="form-control" name="type">
                                    ...
                                    <option value="11">10+ Person</option>
                                </select>
                                <p class="help-block"></p>
                            </div>
                        </div>
...
<?php
			$c = 0;
			$db->select('palaces','title,image',NULL,"type = '$type'",NULL);
...
<?php
		...
		?>			
                <div class="agile_gallery_grid">
                    <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/<?= $image; ?>">
                        <div class="agile_gallery_grid1">
                            <img src="images/<?= $image; ?>" alt="<?= $title; ?>" style="width:100%; height:260px;" class="img-responsive" />
