            ...
            <div class="header">
                <nav class="navbar navbar-default">
                    <div class="navbar-header navbar-left">
                        ...
                        <h1><a class="navbar-brand" href="index.html">Travel Planner</span></a></h1>
                    </div>
...
if(isset($_POST['submit']))
{
	...
	$db->select('user','id,name',NULL,"email= '$username' && password='$password'",NULL);
	$numrows = $db->numRows();
	if($numrows==1)
	{
		...
		$dsadasda = $db->getResult();
		foreach($dsadasda as $rrrs) {
			$_SESSION['user_login_name'] = $rrrs['name'];
		}
	...
	{ ?>
		<div class="has-error" style="border-color:#FF0000;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #FF0000;box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #FF0000; color:#FF0000; padding:5px 0; background-color:#FED5CD; font-weight:bold;">
Invalid : Username or Passowrd</div><br>
<?php
	}	
}
