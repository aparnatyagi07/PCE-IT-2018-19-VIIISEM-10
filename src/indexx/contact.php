...
<section class="contact-w3ls">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong> +91 98280 11111</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:support@travelplanner.com">support@travelplanner.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> B1/22 Gandhi Path, Jaipur</p>											
